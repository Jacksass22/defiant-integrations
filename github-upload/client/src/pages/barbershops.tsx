      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div 
              className="relative bg-gradient-to-br from-blue-600 to-blue-800 p-8 rounded-xl shadow-xl transition-all duration-300 cursor-pointer"
              style={{ 
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="font-serif text-3xl font-bold mb-6 text-white">Smart Booking Software</h3>
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold text-xl text-blue-200 mb-3">Automated Scheduling</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-xl text-blue-200 mb-3">Automated Client Communication</h4>
                    <ul className="space-y-2 text-gray-100">
                  ...
                  <div>
                    <h4 className="font-semibold text-xl text-blue-200 mb-3">Smart Reminders</h4>
                    <ul className="space-y-2 text-gray-100">
            ...
            <div 
              className="relative bg-gradient-to-br from-purple-600 to-purple-800 p-8 rounded-xl shadow-xl transition-all duration-300 cursor-pointer"
              style={{ 
                transformStyle: 'preserve-3d',
                perspective: '1000px'
              }}
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="font-serif text-3xl font-bold mb-6 text-white">Custom Web Design</h3>
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold text-xl text-purple-200 mb-3">Brand-Custom Design</h4>
                    <ul className="space-y-2 text-gray-100">
                  ...
                  <div>
                    <h4 className="font-semibold text-xl text-purple-200 mb-3">Advanced Features</h4>
                    <ul className="space-y-2 text-gray-100">
                  ...
                  <div>
                    <h4 className="font-semibold text-xl text-purple-200 mb-3">Integration & Analytics</h4>
                    <ul className="space-y-2 text-gray-100">
