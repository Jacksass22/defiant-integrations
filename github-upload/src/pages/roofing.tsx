    ...
    <div className="bg-white text-charcoal font-sans">
      ...
      <section className="relative min-h-[60vh] flex items-center pt-16 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <BlurText
              text="Roofing: Smart Technology That Actually Works for Your Business"
              delay={150}
              animateBy="words"
              direction="top"
            ...
            <button 
              ...
              className="inline-flex items-center space-x-2 bg-white text-slate-900 px-8 py-4 font-medium hover:bg-gray-100 transition-colors"
            >
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button 
            onClick={() => setShowLeadCaptureModal(true)}
            className="inline-flex items-center space-x-2 bg-red-700 text-white px-8 py-4 font-medium hover:bg-red-800 transition-colors text-lg"
          >
            <span>Start Your Free Assessment</span>
            <ArrowRight className="w-5 h-5" />
          </button>
      ...
      <LeadCaptureModal
        ...
        title="Transform Your Roofing Business"
        subtitle="Get a customized assessment for your roofing company"
      />
