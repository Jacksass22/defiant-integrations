    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="pt-24 pb-16 relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute top-20 left-20 w-64 h-64 bg-green-500 rounded-full filter blur-3xl opacity-30 animate-pulse"></div>
          <div className="absolute bottom-20 right-20 w-80 h-80 bg-green-400 rounded-full filter blur-3xl opacity-20 animate-pulse delay-1000"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-green-600 rounded-full filter blur-3xl opacity-10 animate-pulse delay-2000"></div>
        </div>
