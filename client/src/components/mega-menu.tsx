                  ...
                  {section.items.map((item, itemIndex) => (
                    <li key={itemIndex}>
                      {item === "HVAC" ? (
                        ...
                        <a href="https://www.instagram.com/defiantintegration/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors block py-1">
                          {item}
                        </a>
                      ) : item === "TikTok" ? (
