...
export default function Electrical() {
  ...
  return (
    <div className="bg-white text-charcoal font-sans">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center pt-16 bg-gradient-to-br from-yellow-900 via-orange-800 to-yellow-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 text-white leading-tight">
              Electrical: Smart Technology That Actually Works for Your Business
            </h1>
