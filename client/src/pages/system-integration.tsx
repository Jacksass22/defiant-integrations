    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
              Integration Investment & Timeline
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Structured integration programs tailored to your business size and complexity
            </p>
          </div>
            ...
            {[
              {
                ...
                subtitle: "Essential connectivity for growing businesses",
                price: "$15K-35K",
              ...
              {
                title: "Medium Enterprise Integration",
                subtitle: "Comprehensive integration for scaling businesses",
                price: "$35K-75K",
                description: "Advanced multi-system integration",
                features: [
                  "5-15 system integrations",
              ...
              {
                title: "Large Organization Integration",
                subtitle: "Enterprise-scale system unification",
                price: "$75K-150K",
                ...
                timeline: "10-16 weeks implementation",
                featured: false
              }
            ].map((tier, index) => (
              <motion.div
              ...
              >
                ...
                <div className="bg-blue-50 rounded-xl p-4 text-center">
                  <div className="text-sm font-semibold text-blue-600 mb-1">Implementation</div>
                  <div className="text-blue-800 font-medium">{tier.timeline}</div>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-600">
                Structured approach to seamless system integration
              </p>
            </div>
            
            <div className="grid md:grid-cols-4 gap-8">
              {[
                { phase: "Weeks 1-2", focus: "Discovery & Architecture", description: "System assessment and integration planning" },
                { phase: "Weeks 3-6", focus: "Development & Testing", description: "API creation and integration development" },
                { phase: "Weeks 7-8", focus: "Deployment & Optimization", description: "System deployment and performance tuning" },
                { phase: "Ongoing", focus: "Monitoring & Enhancement", description: "Continuous monitoring and optimization" }
              ].map((timeline, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <div className="text-2xl font-bold text-blue-600 mb-2">{timeline.phase}</div>
                  <div className="font-semibold text-gray-900 mb-2">{timeline.focus}</div>
