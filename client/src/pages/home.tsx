        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="font-serif text-xl font-bold text-gray-900 mb-3">Smart AI Solutions</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Custom AI assistants that handle real business tasks</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Automated workflows that save time and reduce errors</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Industry-specific AI tools trained for your business</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Multi-team AI agents that work together seamlessly</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="font-serif text-xl font-bold text-gray-900 mb-3">Web & Digital Tools</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">•</span>
                  <span>AI-powered chatbots and customer service tools</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">•</span>
                  <span>Intelligent website search and recommendations</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">•</span>
                  <span>SEO automation and lead generation systems</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="font-serif text-xl font-bold text-gray-900 mb-3">Data & Analytics</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                  <span className="text-purple-600 mr-2">•</span>
                  <span>Turn your business data into actionable insights</span>
                </li>
                <li className="flex items-start">
                  <span className="text-purple-600 mr-2">•</span>
                  <span>Automated inventory tracking and management</span>
                </li>
                <li className="flex items-start">
                  <span className="text-purple-600 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-purple-600 mr-2">•</span>
                  <span>Predictive analytics for better decision-making</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="font-serif text-xl font-bold text-gray-900 mb-3">Strategy & Development</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span>Full-service strategy consulting</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span>Custom app development from concept to launch</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
                  <span>Secure, professional development using Python and modern frameworks</span>
                </li>
                <li className="flex items-start">
                  <span className="text-orange-600 mr-2">•</span>
          ...
          <div className="text-center">
            <Link href="/capabilities" className="inline-flex items-center space-x-2 bg-blue-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg">
