        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><button className="hover:text-emerald-400 transition-colors">AI Strategy</button></li>
                <li><button className="hover:text-emerald-400 transition-colors">Implementation</button></li>
                <li><button className="hover:text-emerald-400 transition-colors">Scaling</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><button className="hover:text-emerald-400 transition-colors">Sign In</button></li>
