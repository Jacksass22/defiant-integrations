    ...
    <div className="bg-white text-charcoal font-sans">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <button 
              ...
              className="inline-flex items-center space-x-2 bg-white text-teal-900 px-8 py-4 font-medium hover:bg-gray-100 transition-colors"
            >
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button 
            onClick={() => setShowLeadCaptureModal(true)}
            className="inline-flex items-center space-x-2 bg-emerald-600 text-white px-8 py-4 font-medium hover:bg-emerald-700 transition-colors text-lg"
          >
            <span>Start Your Free Assessment</span>
            <ArrowRight className="w-5 h-5" />
          </button>
      ...
      <LeadCaptureModal
        ...
        subtitle="Get a customized assessment for your wellness or life coaching business"
      />
