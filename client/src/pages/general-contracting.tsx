    ...
    <div className="bg-white text-charcoal font-sans">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 text-white leading-tight">
              General Contracting: Smart Technology That Actually Works for Your Business
            </h1>
            ...
            <button className="inline-flex items-center space-x-2 bg-white text-amber-900 px-8 py-4 font-medium hover:bg-gray-100 transition-colors">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="inline-flex items-center space-x-2 bg-amber-600 text-white px-8 py-4 font-medium hover:bg-amber-700 transition-colors text-lg">
            <span>Start Your Free Assessment</span>
            <ArrowRight className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><button className="hover:text-amber-400 transition-colors">AI Strategy</button></li>
                <li><button className="hover:text-amber-400 transition-colors">Implementation</button></li>
                <li><button className="hover:text-amber-400 transition-colors">Scaling</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><button className="hover:text-amber-400 transition-colors">Sign In</button></li>
